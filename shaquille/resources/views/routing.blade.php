...
<body>
    <div class="container m-5">
        ...
        <h6 class="mt-4">view routes list</h6>
        <div class="list-group list-group-numbered mt-4">
        <a href="{{ url('php artisan route:list') }}" class="list-group-item list-group-item-action">
            route list
        </a>


        </div>
        <h6 class="mt-4">route chaching</h6>
        <div class="list-group list-group-numbered mt-4">
            <a href="{{ url('php artisan route:cache') }}" class="list-group-item list-group-item-action">
                php artisan route:cache
            </a>
            <a href="{{ url('php artisan route:clear') }}" class="list-group-item list-group-item-action">
