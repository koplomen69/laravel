...
<head>
    ...
    <link rel="preload" as="style" href="https://laravel.com/build/assets/app-c076d646.css" />
    <link rel="modulepreload" href="https://laravel.com/build/assets/app-2c9b9d45.js" />
    <link rel="stylesheet" href="https://laravel.com/build/assets/app-c076d646.css" />
    <script type="module" src="https://laravel.com/build/assets/app-2c9b9d45.js"></script>
...
<body x-data="{
                                        ...
                                        <li>
                                            <a href="/docs/11.x/starter-kits#laravel-breeze" class="flex">
                                                <div class="relative shrink-0 w-12 h-12 bg-breeze flex items-center justify-center rounded-lg overflow-hidden">
                                                    ...
                                                    <img src="/img/ecosystem/breeze.min.svg" alt="Laravel Breeze Logo Logo" class=" w-7 h-7 " width="47" height="32">
                                                </div>
                                        ...
                                        <li>
                                            <a href="/docs/11.x/billing" class="flex">
                                                <div class="relative shrink-0 w-12 h-12 bg-cashier flex items-center justify-center rounded-lg overflow-hidden">
                                                    <span class="absolute inset-0 w-full h-full bg-gradient-to-b from-[rgba(255,255,255,.2)] to-[rgba(255,255,255,0)]"></span>
                                                    <img src="/img/ecosystem/cashier.min.svg" alt="Laravel Cashier Logo" class=" w-7 h-7 " width="47" height="32">
                                                </div>
                                                <div class="ml-4 leading-5">
                                        ...
                                        <li>
                                            <a href="/docs/11.x/dusk" class="flex">
                                                <div class="relative shrink-0 w-12 h-12 bg-dusk flex items-center justify-center rounded-lg overflow-hidden">
                                                    <span class="absolute inset-0 w-full h-full bg-gradient-to-b from-[rgba(255,255,255,.2)] to-[rgba(255,255,255,0)]"></span>
                                                    <img src="/img/ecosystem/dusk.min.svg" alt="Laravel Dusk Logo" class=" w-7 h-7 " width="47" height="32">
                                                </div>
                                                <div class="ml-4 leading-5">
                                        ...
                                        <li>
                                            <a href="/docs/11.x/broadcasting" class="flex">
                                                <div class="relative shrink-0 w-12 h-12 bg-echo flex items-center justify-center rounded-lg overflow-hidden">
                                                    <span class="absolute inset-0 w-full h-full bg-gradient-to-b from-[rgba(255,255,255,.2)] to-[rgba(255,255,255,0)]"></span>
                                                    <img src="/img/ecosystem/echo.min.svg" alt="Laravel Echo Logo" class=" w-7 h-7 " width="47" height="32">
                                                </div>
                                                <div class="ml-4 leading-5">
                                        ...
                                        <li>
                                            <a href="https://envoyer.io" class="flex">
                                                <div class="relative shrink-0 w-12 h-12 bg-envoyer flex items-center justify-center rounded-lg overflow-hidden">
                                                    <span class="absolute inset-0 w-full h-full bg-gradient-to-b from-[rgba(255,255,255,.2)] to-[rgba(255,255,255,0)]"></span>
                                                    <img src="/img/ecosystem/envoyer.min.svg" alt="Envoyer Logo" class=" w-7 h-7 " width="47" height="32">
                                                </div>
                                                <div class="ml-4 leading-5">
                                        ...
                                        <li>
                                            <a href="https://forge.laravel.com" class="flex">
                                                <div class="relative shrink-0 w-12 h-12 bg-forge flex items-center justify-center rounded-lg overflow-hidden">
                                                    <span class="absolute inset-0 w-full h-full bg-gradient-to-b from-[rgba(255,255,255,.2)] to-[rgba(255,255,255,0)]"></span>
                                                    <img src="/img/ecosystem/forge.min.svg" alt="Forge Logo" class=" w-7 h-7 " width="47" height="32">
                                                </div>
                                                <div class="ml-4 leading-5">
                                        ...
                                        <li>
                                            <a href="https://herd.laravel.com" class="flex">
                                                <div class="relative shrink-0 w-12 h-12 bg-herd flex items-center justify-center rounded-lg overflow-hidden">
                                                    <span class="absolute inset-0 w-full h-full bg-gradient-to-b from-[rgba(255,255,255,.2)] to-[rgba(255,255,255,0)]"></span>
                                                    <img src="/img/ecosystem/herd.min.svg" alt="Herd Logo" class=" w-7 h-7 " width="47" height="32">
                                                </div>
                                                <div class="ml-4 leading-5">
                                        ...
                                        <li>
                                            <a href="/docs/11.x/horizon" class="flex">
                                                <div class="relative shrink-0 w-12 h-12 bg-horizon flex items-center justify-center rounded-lg overflow-hidden">
                                                    <span class="absolute inset-0 w-full h-full bg-gradient-to-b from-[rgba(255,255,255,.2)] to-[rgba(255,255,255,0)]"></span>
                                                    <img src="/img/ecosystem/horizon.min.svg" alt="Laravel Horizon Logo" class=" w-7 h-7 " width="47" height="32">
                                                </div>
                                                <div class="ml-4 leading-5">
                                        ...
                                        <li>
                                            <a href="https://inertiajs.com" class="flex">
                                                <div class="relative shrink-0 w-12 h-12 bg-inertia flex items-center justify-center rounded-lg overflow-hidden">
                                                    <span class="absolute inset-0 w-full h-full bg-gradient-to-b from-[rgba(255,255,255,.2)] to-[rgba(255,255,255,0)]"></span>
                                                    <img src="/img/ecosystem/inertia.min.svg" alt="Inertia Logo" class=" w-7 h-7 " width="47" height="32">
                                                </div>
                                                <div class="ml-4 leading-5">
                                        ...
                                        <li>
                                            <a href="https://jetstream.laravel.com" class="flex">
                                                <div class="relative shrink-0 w-12 h-12 bg-jetstream flex items-center justify-center rounded-lg overflow-hidden">
                                                    <span class="absolute inset-0 w-full h-full bg-gradient-to-b from-[rgba(255,255,255,.2)] to-[rgba(255,255,255,0)]"></span>
                                                    <img src="/img/ecosystem/jetstream.min.svg" alt="Laravel Jetstream Logo" class=" w-7 h-7 " width="47" height="32">
                                                </div>
                                                <div class="ml-4 leading-5">
                                        ...
                                        <li>
                                            <a href="https://livewire.laravel.com" class="flex">
                                                <div class="relative shrink-0 w-12 h-12 bg-livewire flex items-center justify-center rounded-lg overflow-hidden">
                                                    <span class="absolute inset-0 w-full h-full bg-gradient-to-b from-[rgba(255,255,255,.2)] to-[rgba(255,255,255,0)]"></span>
                                                    <img src="/img/ecosystem/livewire.min.svg" alt="Laravel Livewire Logo" class=" w-7 h-7 " width="47" height="32">
                                                </div>
                                                <div class="ml-4 leading-5">
                                        ...
                                        <li>
                                            <a href="https://nova.laravel.com" class="flex">
                                                <div class="relative shrink-0 w-12 h-12 bg-nova flex items-center justify-center rounded-lg overflow-hidden">
                                                    <span class="absolute inset-0 w-full h-full bg-gradient-to-b from-[rgba(255,255,255,.2)] to-[rgba(255,255,255,0)]"></span>
                                                    <img src="/img/ecosystem/nova.min.svg" alt="Laravel Nova Logo" class=" w-7 h-7 " width="47" height="32">
                                                </div>
                                                <div class="ml-4 leading-5">
                                        ...
                                        <li>
                                            <a href="/docs/11.x/octane" class="flex">
                                                <div class="relative shrink-0 w-12 h-12 bg-octane flex items-center justify-center rounded-lg overflow-hidden">
                                                    <span class="absolute inset-0 w-full h-full bg-gradient-to-b from-[rgba(255,255,255,.2)] to-[rgba(255,255,255,0)]"></span>
                                                    <img src="/img/ecosystem/octane.min.svg" alt="Laravel Octane Logo" class=" w-7 h-7 " width="47" height="32">
                                                </div>
                                                <div class="ml-4 leading-5">
                                        ...
                                        <li>
                                            <a href="/docs/11.x/pennant" class="flex">
                                                <div class="relative shrink-0 w-12 h-12 bg-pennant flex items-center justify-center rounded-lg overflow-hidden">
                                                    <span class="absolute inset-0 w-full h-full bg-gradient-to-b from-[rgba(255,255,255,.2)] to-[rgba(255,255,255,0)]"></span>
                                                    <img src="/img/ecosystem/pennant.min.svg" alt="Laravel Pennant Logo" class=" w-9 h-9 " width="47" height="32">
                                                </div>
                                                <div class="ml-4 leading-5">
                                        ...
                                        <li>
                                            <a href="/docs/11.x/pint" class="flex">
                                                <div class="relative shrink-0 w-12 h-12 bg-pint flex items-center justify-center rounded-lg overflow-hidden">
                                                    <span class="absolute inset-0 w-full h-full bg-gradient-to-b from-[rgba(255,255,255,.2)] to-[rgba(255,255,255,0)]"></span>
                                                    <img src="/img/ecosystem/pint.min.svg" alt="Laravel Pint Logo" class=" w-7 h-7 " width="47" height="32">
                                                </div>
                                                <div class="ml-4 leading-5">
                                        ...
                                        <li>
                                            <a href="/docs/11.x/prompts" class="flex">
                                                <div class="relative shrink-0 w-12 h-12 bg-prompts flex items-center justify-center rounded-lg overflow-hidden">
                                                    <span class="absolute inset-0 w-full h-full bg-gradient-to-b from-[rgba(255,255,255,.2)] to-[rgba(255,255,255,0)]"></span>
                                                    <img src="/img/ecosystem/prompts.min.svg" alt="Laravel Prompts Logo" class=" w-7 h-7 " width="47" height="32">
                                                </div>
                                                <div class="ml-4 leading-5">
                                        ...
                                        <li>
                                            <a href="https://pulse.laravel.com" class="flex">
                                                <div class="relative shrink-0 w-12 h-12 bg-pulse flex items-center justify-center rounded-lg overflow-hidden">
                                                    <span class="absolute inset-0 w-full h-full bg-gradient-to-b from-[rgba(255,255,255,.2)] to-[rgba(255,255,255,0)]"></span>
                                                    <img src="/img/ecosystem/pulse.min.svg" alt="Laravel Pulse Logo" class=" w-7 h-7 " width="47" height="32">
                                                </div>
                                                <div class="ml-4 leading-5">
                                        ...
                                        <li>
                                            <a href="https://reverb.laravel.com" class="flex">
                                                <div class="relative shrink-0 w-12 h-12 bg-reverb flex items-center justify-center rounded-lg overflow-hidden">
                                                    <span class="absolute inset-0 w-full h-full bg-gradient-to-b from-[rgba(255,255,255,.2)] to-[rgba(255,255,255,0)]"></span>
                                                    <img src="/img/ecosystem/reverb.min.svg" alt="Laravel Reverb Logo" class=" w-7 h-7 " width="47" height="32">
                                                </div>
                                                <div class="ml-4 leading-5">
                                        ...
                                        <li>
                                            <a href="/docs/11.x/sail" class="flex">
                                                <div class="relative shrink-0 w-12 h-12 bg-sail flex items-center justify-center rounded-lg overflow-hidden">
                                                    <span class="absolute inset-0 w-full h-full bg-gradient-to-b from-[rgba(255,255,255,.2)] to-[rgba(255,255,255,0)]"></span>
                                                    <img src="/img/ecosystem/sail.min.svg" alt="Laravel Sail Logo" class=" w-7 h-7 " width="47" height="32">
                                                </div>
                                                <div class="ml-4 leading-5">
                                        ...
                                        <li>
                                            <a href="/docs/11.x/sanctum" class="flex">
                                                <div class="relative shrink-0 w-12 h-12 bg-sanctum flex items-center justify-center rounded-lg overflow-hidden">
                                                    <span class="absolute inset-0 w-full h-full bg-gradient-to-b from-[rgba(255,255,255,.2)] to-[rgba(255,255,255,0)]"></span>
                                                    <img src="/img/ecosystem/sanctum.min.svg" alt="Laravel Sanctum Logo" class=" w-7 h-7 " width="47" height="32">
                                                </div>
                                                <div class="ml-4 leading-5">
                                        ...
                                        <li>
                                            <a href="/docs/11.x/scout" class="flex">
                                                <div class="relative shrink-0 w-12 h-12 bg-scout flex items-center justify-center rounded-lg overflow-hidden">
                                                    <span class="absolute inset-0 w-full h-full bg-gradient-to-b from-[rgba(255,255,255,.2)] to-[rgba(255,255,255,0)]"></span>
                                                    <img src="/img/ecosystem/scout.min.svg" alt="Laravel Scout Logo" class=" w-7 h-7 " width="47" height="32">
                                                </div>
                                                <div class="ml-4 leading-5">
                                        ...
                                        <li>
                                            <a href="/docs/11.x/socialite" class="flex">
                                                <div class="relative shrink-0 w-12 h-12 bg-socialite flex items-center justify-center rounded-lg overflow-hidden">
                                                    <span class="absolute inset-0 w-full h-full bg-gradient-to-b from-[rgba(255,255,255,.2)] to-[rgba(255,255,255,0)]"></span>
                                                    <img src="/img/ecosystem/socialite.min.svg" alt="Laravel Socialite Logo" class=" w-7 h-7 " width="47" height="32">
                                                </div>
                                                <div class="ml-4 leading-5">
                                        ...
                                        <li>
                                            <a href="https://spark.laravel.com" class="flex">
                                                <div class="relative shrink-0 w-12 h-12 bg-spark flex items-center justify-center rounded-lg overflow-hidden">
                                                    <span class="absolute inset-0 w-full h-full bg-gradient-to-b from-[rgba(255,255,255,.2)] to-[rgba(255,255,255,0)]"></span>
                                                    <img src="/img/ecosystem/spark.min.svg" alt="Laravel Spark Logo" class=" w-7 h-7 " width="47" height="32">
                                                </div>
                                                <div class="ml-4 leading-5">
                                        ...
                                        <li>
                                            <a href="/docs/11.x/telescope" class="flex">
                                                <div class="relative shrink-0 w-12 h-12 bg-telescope flex items-center justify-center rounded-lg overflow-hidden">
                                                    <span class="absolute inset-0 w-full h-full bg-gradient-to-b from-[rgba(255,255,255,.2)] to-[rgba(255,255,255,0)]"></span>
                                                    <img src="/img/ecosystem/telescope.min.svg" alt="Laravel Telescope Logo" class=" w-7 h-7 " width="47" height="32">
                                                </div>
                                                <div class="ml-4 leading-5">
                                        ...
                                        <li>
                                            <a href="https://vapor.laravel.com" class="flex">
                                                <div class="relative shrink-0 w-12 h-12 bg-vapor flex items-center justify-center rounded-lg overflow-hidden">
                                                    <span class="absolute inset-0 w-full h-full bg-gradient-to-b from-[rgba(255,255,255,.2)] to-[rgba(255,255,255,0)]"></span>
                                                    <img src="/img/ecosystem/vapor.min.svg" alt="Laravel Vapor Logo" class=" w-7 h-7 " width="47" height="32">
                                                </div>
                                                <div class="ml-4 leading-5">
            ...
            setTimeout(() => {
                ...
                <div class="relative">
                    <h1 class="max-w-3xl mx-auto text-5xl font-bold text-center md:text-6xl lg:text-7xl">The PHP Framework
                        <br class="hidden lg:inline"><span class="text-red-500">for Web Artisans</span>
                    </h1>
            ...
            <div class="relative w-full grid gap-12 lg:grid-cols-2">
                ...
                <div class="w-full flex justify-center items-center px-5 xl:px-0">
                    <div class="sm:max-w-[480px]">
                        ...
                        <a class="group relative inline-flex border border-red-600 focus:outline-none mt-6" href="/docs">
                            <span class="w-full inline-flex items-center justify-center self-stretch px-4 py-2 text-sm text-red-600 text-center font-bold uppercase bg-white ring-1 ring-red-600 ring-offset-1 transform transition-transform group-hover:-translate-y-1 group-hover:-translate-x-1 group-focus:-translate-y-1 group-focus:-translate-x-1">
                                Start Learning
                            </span>
                        </a>
    ...
    <div class="relative overflow-hidden pt-12 pb-16 md:pt-24 lg:pt-48">
        <div class="max-w-screen-xl w-full mx-auto px-5 grid gap-12 lg:grid-cols-2">
            <div class="flex justify-center items-center">
                <svg class="w-[302px] lg:w-[454px] max-w-full" width="454" height="219" viewBox="0 0 454 219" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M215 124H315V210H215V124ZM1 124H101V210H1V124ZM345 124H445V210H345V124ZM131 124H185V210H131V124Z" stroke="#FF2D20" stroke-width="2" />
                    <path d="M223 132H323V218H223V132ZM9 132H109V218H9V132ZM353 132H453V218H353V132ZM139 132H193V218H139V132Z" fill="white" stroke="#565454" stroke-width="2" />
                    <path d="M229 138H234" stroke="#565454" stroke-width="2" />
                    <path d="M219.625 39.375V47.25M219.625 12.375L211.75 7.875L203.875 12.375L211.75 16.875L219.625 12.375ZM219.625 12.375V30.375" stroke="#FF2D20" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                    <path d="M203.875 12.375V38.25L219.625 47.25L235.375 38.25V21.375" stroke="#FF2D20" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                    <path d="M211.75 16.875V34.875L219.625 39.375L243.25 25.875V16.875" stroke="#FF2D20" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                    <path d="M227.5 16.875L235.375 12.375L243.25 16.875L235.375 21.375L227.5 16.875ZM227.5 16.875V25.875M227.5 25.875L235.375 30.375M227.5 25.875L211.75 34.875" stroke="#FF2D20" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                    <path d="M237 138H242M163 139H169M245 138H250M15 138H20M359 138H364M23 138H28M367 138H372M31 138H36M375 138H380" stroke="#565454" stroke-width="2" />
                    <path d="M394 124V94M264 124V94M50 124V94M222 94V64M157 124V94M49 94H395" stroke="#FF2D20" stroke-width="2" />
                    <path d="M70.1326 170.39C69.7814 170.271 69.4272 170.161 69.0704 170.06C69.1303 169.818 69.1855 169.579 69.2345 169.345C70.0386 165.493 69.5129 162.39 67.7174 161.369C65.9958 160.389 63.1804 161.41 60.337 163.852C60.0568 164.093 59.7827 164.341 59.5152 164.596C59.3361 164.427 59.1539 164.26 58.9685 164.098C55.9885 161.487 53.0014 160.387 51.2078 161.411C49.4879 162.394 48.9785 165.311 49.7025 168.961C49.7745 169.322 49.8558 169.682 49.9464 170.039C49.5236 170.158 49.1156 170.284 48.7251 170.418C45.2312 171.62 43 173.504 43 175.458C43 177.476 45.3953 179.5 49.0344 180.727C49.3294 180.826 49.6269 180.918 49.9265 181.002C49.8292 181.387 49.7428 181.775 49.
/>
                    <path fill-rule="evenodd" clip-rule="evenodd" d="M282.878 185.417C286.938 179.381 287.042 172.687 283.192 165.333C286.046 168.255 287.808 172.264 287.808 176.688C287.808 179.245 287.22 181.661 286.173 183.811C285.578 184.675 285.124 185.741 283.913 185.741C283.543 185.744 283.181 185.631 282.878 185.417Z" fill="#E24CA6" />
                    <path fill-rule="evenodd" clip-rule="evenodd" d="M271.483 180.707C276.871 180.707 279.139 177.583 279.139 173.148C279.139 168.712 275.711 164.63 271.483 164.63C267.254 164.63 263.826 168.712 263.826 173.148C263.826 177.584 266.094 180.707 271.483 180.707Z" fill="white" />
                    <path fill-rule="evenodd" clip-rule="evenodd" d="M272.295 170.233C272.295 171.981 271.009 173.4 269.424 173.4C267.837 173.4 266.552 171.981 266.552 170.233C266.552 168.484 267.837 167.065 269.424 167.065C271.009 167.065 272.295 168.484 272.295 170.233Z" fill="#030776" />
                    <path fill-rule="evenodd" clip-rule="evenodd" d="M270.38 169.502C270.38 170.309 269.738 170.963 268.945 170.963C268.151 170.963 267.509 170.309 267.509 169.502C267.509 168.695 268.151 168.041 268.945 168.041C269.738 168.041 270.38 168.695 270.38 169.502Z" fill="white" />
                    <path d="M168.922 163.007C168.922 163.007 175.139 166.561 176.766 172.207C178.232 177.307 177.058 179.741 177.058 179.741C177.808 180.558 178.399 181.507 178.8 182.541C179.203 183.205 179.44 183.957 179.491 184.732C179.541 185.507 179.404 186.283 179.09 186.994C179.09 186.994 178.99 184.914 175.89 184.483C173.049 184.083 172.016 186.849 166.59 186.715C163.584 186.658 160.637 185.866 158.007 184.409C155.376 182.951 153.143 180.873 151.5 178.354C154.151 179.8 157.624 182.045 161.949 181.7C166.274 181.355 167.177 180.026 167.177 180.026C162.315 176.179 158.012 171.675 154.391 166.643C157.791 169.488 166.213 175.15 166.017 175.006C162.936 171.996 160.118 168.729 157.592 165.24C157.592 165.24 170.228 175.629 171.245 175.563C171.663 174.702 173.824 170.245 168.921 163.006L168.922 163.007Z" fill="url(#paint0_linear_1_2)" />
                    <defs>
            ...
            <div class="w-full flex justify-center items-center">
                <div class="sm:max-w-[480px]">
                    ...
                    <p class="mt-6 text-gray-700 leading-relaxed">Build robust, full-stack applications in PHP using
                        ...
                        JavaScript? Build a monolithic React or Vue driven frontend by pairing Laravel with <a class="underline" href="https://inertiajs.com">Inertia</a>.</p>
                    <p class="mt-6 text-gray-700 leading-relaxed">Or, let Laravel serve as a robust backend API for your
                        ...
                        you productive in minutes.</p>

                    <a class="group relative inline-flex border border-red-600 focus:outline-none mt-6" href="/frontend">
                        <span class="w-full inline-flex items-center justify-center self-stretch px-4 py-2 text-sm text-red-600 text-center font-bold uppercase bg-white ring-1 ring-red-600 ring-offset-1 transform transition-transform group-hover:-translate-y-1 group-hover:-translate-x-1 group-focus:-translate-y-1 group-focus:-translate-x-1">
    ...
    <div class="relative overflow-hidden py-16 md:pt-48">
        ...
        init() {
            ...
            <p class="mt-6 text-gray-700 leading-relaxed max-w-3xl">Out of the box, Laravel has elegant solutions for the
                common features needed by all modern web applications. It's time to start building amazing applications and
                stop wasting time searching for packages and reinventing the wheel.</p>
        ...
        updateScrollPosition(event) {
            ...
            this.scrolledRight = (el.scrollWidth - el.offsetWidth) === el.scrollLeft
                ...
                <nav class="w-full flex relative lg:max-w-xs">
                    ...
                    <ul id="feature-nav" class="flex-1 divide-x lg:divide-x-0 lg:divide-y divide-gray-100 max-h-full overflow-x-auto lg:overflow-x-visible lg:overflow-y-auto lg:overscroll-y-contain flex lg:block whitespace-nowrap text-sm lg:text-base" @scroll.throttle.50ms="updateScrollPosition">
                        <li>
        ...
        changeTab(location.hash.substring(1));
            ...
            <p class="mt-12 text-gray-700 leading-relaxed max-w-3xl">We've just scratched the surface. Laravel has you
                ...
                limiting, and custom console commands. Check out the <a href="https://laravel.com/docs" class="text-red-600 underline hover:no-underline">Laravel documentation</a> to keep learning.</p>
        </div>
    </div>
            ...
            <div class="relative w-full grid gap-12 lg:grid-cols-2">
                ...
                <div class="w-full flex justify-center items-center px-5 xl:px-0">
                    <div class="sm:max-w-[480px]">
                        ...
                        <p class="mt-6 text-gray-700 leading-relaxed">Laravel is committed to delivering the best testing
                            experience you can imagine. No more brittle tests that are a nightmare to maintain. Beautiful
                            testing APIs, database seeding, and painless browser testing let you ship with confidence.</p>
    ...
    <div class="max-w-screen-xl mx-auto px-5 pt-16 pb-24 md:pt-24 lg:pt-48">
        <div class="sm:max-w-xl">
            ...
            <p class="mt-6 text-gray-700 leading-relaxed">Our vast library of meticulously maintained packages means you're
                ready for anything. Let <a class="underline" href="/docs/octane">Laravel Octane</a> supercharge your
                application's performance, and experience infinite scale on <a class="underline" href="https://vapor.laravel.com">Laravel Vapor</a>, our serverless deployment platform powered by AWS
                Lambda.</p>
        </div>
            ...
            <li>
                <a href="https://forge.laravel.com" class="flex items-start pt-4 pb-6 px-4 border border-gray-200 border-opacity-60">
                    <div class="relative shrink-0 bg-forge flex items-center justify-center w-12 h-12 rounded-lg overflow-hidden">
                        ...
                        <img src="/img/ecosystem/forge.min.svg" alt="Forge Logo" class="relative w-7 h-7">
                    </div>
                    <div class="ml-4 leading-5">
                        <div>Forge</div>
            ...
            <li>
                <a href="https://vapor.laravel.com" class="flex items-start pt-4 pb-6 px-4 border border-gray-200 border-opacity-60">
                    <div class="relative shrink-0 bg-vapor flex items-center justify-center w-12 h-12 rounded-lg overflow-hidden">
                        <span class="absolute w-full h-full inset-0 bg-gradient-to-b from-[rgba(255,255,255,.2)] to-[rgba(255,255,255,0)]"></span>
                        <img src="/img/ecosystem/vapor.min.svg" alt="Vapor Logo" class="relative w-7 h-7">
                    </div>
                    <div class="ml-4 leading-5">
                        <div>Vapor</div>
        ...
        <ul class="mt-10 relative grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            <li>
                <a href="/docs/11.x/starter-kits#laravel-breeze" class="flex p-4 border border-gray-200 border-opacity-60">
                    <div class="relative shrink-0 bg-breeze flex items-center justify-center w-12 h-12 rounded-lg overflow-hidden">
                        <span class="absolute w-full h-full inset-0 bg-gradient-to-b from-[rgba(255,255,255,.2)] to-[rgba(255,255,255,0)]"></span>
                        <img src="/img/ecosystem/breeze.min.svg" alt="Laravel Breeze Logo Logo" class="relative  w-7 h-7 ">
                    </div>
                    <div class="ml-4 leading-5">
                        <div>Breeze</div>
            ...
            <li>
                <a href="/docs/11.x/billing" class="flex p-4 border border-gray-200 border-opacity-60">
                    <div class="relative shrink-0 bg-cashier flex items-center justify-center w-12 h-12 rounded-lg overflow-hidden">
                        <span class="absolute w-full h-full inset-0 bg-gradient-to-b from-[rgba(255,255,255,.2)] to-[rgba(255,255,255,0)]"></span>
                        <img src="/img/ecosystem/cashier.min.svg" alt="Laravel Cashier Logo" class="relative  w-7 h-7 ">
                    </div>
                    <div class="ml-4 leading-5">
                        <div>Cashier</div>
            ...
            <li>
                <a href="/docs/11.x/dusk" class="flex p-4 border border-gray-200 border-opacity-60">
                    <div class="relative shrink-0 bg-dusk flex items-center justify-center w-12 h-12 rounded-lg overflow-hidden">
                        <span class="absolute w-full h-full inset-0 bg-gradient-to-b from-[rgba(255,255,255,.2)] to-[rgba(255,255,255,0)]"></span>
                        <img src="/img/ecosystem/dusk.min.svg" alt="Laravel Dusk Logo" class="relative  w-7 h-7 ">
                    </div>
                    <div class="ml-4 leading-5">
                        <div>Dusk</div>
            ...
            <li>
                <a href="/docs/11.x/broadcasting" class="flex p-4 border border-gray-200 border-opacity-60">
                    <div class="relative shrink-0 bg-echo flex items-center justify-center w-12 h-12 rounded-lg overflow-hidden">
                        <span class="absolute w-full h-full inset-0 bg-gradient-to-b from-[rgba(255,255,255,.2)] to-[rgba(255,255,255,0)]"></span>
                        <img src="/img/ecosystem/echo.min.svg" alt="Laravel Echo Logo" class="relative  w-7 h-7 ">
                    </div>
                    <div class="ml-4 leading-5">
                        <div>Echo</div>
            ...
            <li>
                <a href="https://envoyer.io" class="flex p-4 border border-gray-200 border-opacity-60">
                    <div class="relative shrink-0 bg-envoyer flex items-center justify-center w-12 h-12 rounded-lg overflow-hidden">
                        <span class="absolute w-full h-full inset-0 bg-gradient-to-b from-[rgba(255,255,255,.2)] to-[rgba(255,255,255,0)]"></span>
                        <img src="/img/ecosystem/envoyer.min.svg" alt="Envoyer Logo" class="relative  w-7 h-7 ">
                    </div>
                    <div class="ml-4 leading-5">
                        <div>Envoyer</div>
            ...
            <li>
                <a href="https://herd.laravel.com" class="flex p-4 border border-gray-200 border-opacity-60">
                    <div class="relative shrink-0 bg-herd flex items-center justify-center w-12 h-12 rounded-lg overflow-hidden">
                        <span class="absolute w-full h-full inset-0 bg-gradient-to-b from-[rgba(255,255,255,.2)] to-[rgba(255,255,255,0)]"></span>
                        <img src="/img/ecosystem/herd.min.svg" alt="Herd Logo" class="relative  w-7 h-7 ">
                    </div>
                    <div class="ml-4 leading-5">
                        <div>Herd</div>
            ...
            <li>
                <a href="/docs/11.x/horizon" class="flex p-4 border border-gray-200 border-opacity-60">
                    <div class="relative shrink-0 bg-horizon flex items-center justify-center w-12 h-12 rounded-lg overflow-hidden">
                        <span class="absolute w-full h-full inset-0 bg-gradient-to-b from-[rgba(255,255,255,.2)] to-[rgba(255,255,255,0)]"></span>
                        <img src="/img/ecosystem/horizon.min.svg" alt="Laravel Horizon Logo" class="relative  w-7 h-7 ">
                    </div>
                    <div class="ml-4 leading-5">
                        <div>Horizon</div>
            ...
            <li>
                <a href="https://inertiajs.com" class="flex p-4 border border-gray-200 border-opacity-60">
                    <div class="relative shrink-0 bg-inertia flex items-center justify-center w-12 h-12 rounded-lg overflow-hidden">
                        <span class="absolute w-full h-full inset-0 bg-gradient-to-b from-[rgba(255,255,255,.2)] to-[rgba(255,255,255,0)]"></span>
                        <img src="/img/ecosystem/inertia.min.svg" alt="Inertia Logo" class="relative  w-7 h-7 ">
                    </div>
                    <div class="ml-4 leading-5">
                        <div>Inertia</div>
                        <div class="mt-1 text-sm text-gray-700">Create modern single-page React and Vue apps using classic server-side routing.</div>
                    </div>
                </a>
            </li>
            <li>
                <a href="https://jetstream.laravel.com" class="flex p-4 border border-gray-200 border-opacity-60">
                    <div class="relative shrink-0 bg-jetstream flex items-center justify-center w-12 h-12 rounded-lg overflow-hidden">
                        <span class="absolute w-full h-full inset-0 bg-gradient-to-b from-[rgba(255,255,255,.2)] to-[rgba(255,255,255,0)]"></span>
                        <img src="/img/ecosystem/jetstream.min.svg" alt="Laravel Jetstream Logo" class="relative  w-7 h-7 ">
                    </div>
                    <div class="ml-4 leading-5">
                        <div>Jetstream</div>
            ...
            <li>
                <a href="https://livewire.laravel.com" class="flex p-4 border border-gray-200 border-opacity-60">
                    <div class="relative shrink-0 bg-livewire flex items-center justify-center w-12 h-12 rounded-lg overflow-hidden">
                        <span class="absolute w-full h-full inset-0 bg-gradient-to-b from-[rgba(255,255,255,.2)] to-[rgba(255,255,255,0)]"></span>
                        <img src="/img/ecosystem/livewire.min.svg" alt="Laravel Livewire Logo" class="relative  w-7 h-7 ">
                    </div>
                    <div class="ml-4 leading-5">
                        <div>Livewire</div>
                        <div class="mt-1 text-sm text-gray-700">Build reactive, dynamic applications using Laravel and Blade.</div>
                    </div>
                </a>
            </li>
            <li>
                <a href="https://nova.laravel.com" class="flex p-4 border border-gray-200 border-opacity-60">
                    <div class="relative shrink-0 bg-nova flex items-center justify-center w-12 h-12 rounded-lg overflow-hidden">
                        <span class="absolute w-full h-full inset-0 bg-gradient-to-b from-[rgba(255,255,255,.2)] to-[rgba(255,255,255,0)]"></span>
                        <img src="/img/ecosystem/nova.min.svg" alt="Laravel Nova Logo" class="relative  w-7 h-7 ">
                    </div>
                    <div class="ml-4 leading-5">
                        <div>Nova</div>
            ...
            <li>
                <a href="/docs/11.x/octane" class="flex p-4 border border-gray-200 border-opacity-60">
                    <div class="relative shrink-0 bg-octane flex items-center justify-center w-12 h-12 rounded-lg overflow-hidden">
                        <span class="absolute w-full h-full inset-0 bg-gradient-to-b from-[rgba(255,255,255,.2)] to-[rgba(255,255,255,0)]"></span>
                        <img src="/img/ecosystem/octane.min.svg" alt="Laravel Octane Logo" class="relative  w-7 h-7 ">
                    </div>
                    <div class="ml-4 leading-5">
                        <div>Octane</div>
            ...
            <li>
                <a href="/docs/11.x/pennant" class="flex p-4 border border-gray-200 border-opacity-60">
                    <div class="relative shrink-0 bg-pennant flex items-center justify-center w-12 h-12 rounded-lg overflow-hidden">
                        <span class="absolute w-full h-full inset-0 bg-gradient-to-b from-[rgba(255,255,255,.2)] to-[rgba(255,255,255,0)]"></span>
                        <img src="/img/ecosystem/pennant.min.svg" alt="Laravel Pennant Logo" class="relative  w-9 h-9 ">
                    </div>
                    <div class="ml-4 leading-5">
                        <div>Pennant</div>
                        <div class="mt-1 text-sm text-gray-700">A simple, lightweight library for managing feature flags.</div>
                    </div>
                </a>
            </li>
            <li>
                <a href="/docs/11.x/pint" class="flex p-4 border border-gray-200 border-opacity-60">
                    <div class="relative shrink-0 bg-pint flex items-center justify-center w-12 h-12 rounded-lg overflow-hidden">
                        <span class="absolute w-full h-full inset-0 bg-gradient-to-b from-[rgba(255,255,255,.2)] to-[rgba(255,255,255,0)]"></span>
                        <img src="/img/ecosystem/pint.min.svg" alt="Laravel Pint Logo" class="relative  w-7 h-7 ">
                    </div>
                    <div class="ml-4 leading-5">
                        <div>Pint</div>
            ...
            <li>
                <a href="/docs/11.x/prompts" class="flex p-4 border border-gray-200 border-opacity-60">
                    <div class="relative shrink-0 bg-prompts flex items-center justify-center w-12 h-12 rounded-lg overflow-hidden">
                        <span class="absolute w-full h-full inset-0 bg-gradient-to-b from-[rgba(255,255,255,.2)] to-[rgba(255,255,255,0)]"></span>
                        <img src="/img/ecosystem/prompts.min.svg" alt="Laravel Prompts Logo" class="relative  w-7 h-7 ">
                    </div>
                    <div class="ml-4 leading-5">
                        <div>Prompts</div>
                        <div class="mt-1 text-sm text-gray-700">Beautiful and user-friendly forms for command-line applications.</div>
                    </div>
                </a>
            </li>
            <li>
                <a href="https://pulse.laravel.com" class="flex p-4 border border-gray-200 border-opacity-60">
                    <div class="relative shrink-0 bg-pulse flex items-center justify-center w-12 h-12 rounded-lg overflow-hidden">
                        <span class="absolute w-full h-full inset-0 bg-gradient-to-b from-[rgba(255,255,255,.2)] to-[rgba(255,255,255,0)]"></span>
                        <img src="/img/ecosystem/pulse.min.svg" alt="Laravel Pulse Logo" class="relative  w-7 h-7 ">
                    </div>
                    <div class="ml-4 leading-5">
                        <div>Pulse</div>
                        <div class="mt-1 text-sm text-gray-700">At-a-glance insights into your application&#039;s performance and usage.</div>
                    </div>
                </a>
            </li>
            <li>
                <a href="https://reverb.laravel.com" class="flex p-4 border border-gray-200 border-opacity-60">
                    <div class="relative shrink-0 bg-reverb flex items-center justify-center w-12 h-12 rounded-lg overflow-hidden">
                        <span class="absolute w-full h-full inset-0 bg-gradient-to-b from-[rgba(255,255,255,.2)] to-[rgba(255,255,255,0)]"></span>
                        <img src="/img/ecosystem/reverb.min.svg" alt="Laravel Reverb Logo" class="relative  w-7 h-7 ">
                    </div>
                    <div class="ml-4 leading-5">
                        <div>Reverb</div>
                        <div class="mt-1 text-sm text-gray-700">Blazing fast and scalable WebSockets for your application.</div>
                    </div>
                </a>
            </li>
            <li>
                <a href="/docs/11.x/sail" class="flex p-4 border border-gray-200 border-opacity-60">
                    <div class="relative shrink-0 bg-sail flex items-center justify-center w-12 h-12 rounded-lg overflow-hidden">
                        <span class="absolute w-full h-full inset-0 bg-gradient-to-b from-[rgba(255,255,255,.2)] to-[rgba(255,255,255,0)]"></span>
                        <img src="/img/ecosystem/sail.min.svg" alt="Laravel Sail Logo" class="relative  w-7 h-7 ">
                    </div>
                    <div class="ml-4 leading-5">
                        <div>Sail</div>
            ...
            <li>
                <a href="/docs/11.x/sanctum" class="flex p-4 border border-gray-200 border-opacity-60">
                    <div class="relative shrink-0 bg-sanctum flex items-center justify-center w-12 h-12 rounded-lg overflow-hidden">
                        <span class="absolute w-full h-full inset-0 bg-gradient-to-b from-[rgba(255,255,255,.2)] to-[rgba(255,255,255,0)]"></span>
                        <img src="/img/ecosystem/sanctum.min.svg" alt="Laravel Sanctum Logo" class="relative  w-7 h-7 ">
                    </div>
                    <div class="ml-4 leading-5">
                        <div>Sanctum</div>
            ...
            <li>
                <a href="/docs/11.x/scout" class="flex p-4 border border-gray-200 border-opacity-60">
                    <div class="relative shrink-0 bg-scout flex items-center justify-center w-12 h-12 rounded-lg overflow-hidden">
                        <span class="absolute w-full h-full inset-0 bg-gradient-to-b from-[rgba(255,255,255,.2)] to-[rgba(255,255,255,0)]"></span>
                        <img src="/img/ecosystem/scout.min.svg" alt="Laravel Scout Logo" class="relative  w-7 h-7 ">
                    </div>
                    <div class="ml-4 leading-5">
                        <div>Scout</div>
            ...
            <li>
                <a href="/docs/11.x/socialite" class="flex p-4 border border-gray-200 border-opacity-60">
                    <div class="relative shrink-0 bg-socialite flex items-center justify-center w-12 h-12 rounded-lg overflow-hidden">
                        <span class="absolute w-full h-full inset-0 bg-gradient-to-b from-[rgba(255,255,255,.2)] to-[rgba(255,255,255,0)]"></span>
                        <img src="/img/ecosystem/socialite.min.svg" alt="Laravel Socialite Logo" class="relative  w-7 h-7 ">
                    </div>
                    <div class="ml-4 leading-5">
                        <div>Socialite</div>
            ...
            <li>
                <a href="https://spark.laravel.com" class="flex p-4 border border-gray-200 border-opacity-60">
                    <div class="relative shrink-0 bg-spark flex items-center justify-center w-12 h-12 rounded-lg overflow-hidden">
                        <span class="absolute w-full h-full inset-0 bg-gradient-to-b from-[rgba(255,255,255,.2)] to-[rgba(255,255,255,0)]"></span>
                        <img src="/img/ecosystem/spark.min.svg" alt="Laravel Spark Logo" class="relative  w-7 h-7 ">
                    </div>
                    <div class="ml-4 leading-5">
                        <div>Spark</div>
            ...
            <li>
                <a href="/docs/11.x/telescope" class="flex p-4 border border-gray-200 border-opacity-60">
                    <div class="relative shrink-0 bg-telescope flex items-center justify-center w-12 h-12 rounded-lg overflow-hidden">
                        <span class="absolute w-full h-full inset-0 bg-gradient-to-b from-[rgba(255,255,255,.2)] to-[rgba(255,255,255,0)]"></span>
                        <img src="/img/ecosystem/telescope.min.svg" alt="Laravel Telescope Logo" class="relative  w-7 h-7 ">
                    </div>
                    <div class="ml-4 leading-5">
                        <div>Telescope</div>
            ...
            <blockquote class="relative w-full bg-white p-5 border border-gray-200 break-inside-avoid-column">
                ...
                <div class="mt-5 flex items-start gap-4">
                    ...
                    <div class="text-xs">
                        ...
                        <p class="text-gray-700">Creator of <a href="https://torchlight.dev" target="_blank" class="text-red-500">Torchlight</a> and
                            <a href="https://github.com/hammerstonedev/sidecar" target="_blank" class="text-red-500">Sidecar</a>
                        </p>
                    </div>
                </div>
            </blockquote>
            ...
            <blockquote class="relative w-full bg-white p-5 border border-gray-200 break-inside-avoid-column">
                ...
                <div class="mt-5 flex items-start gap-4">
                    ...
                    <div class="text-xs">
                        ...
                        <p class="text-gray-700">Creator of <a href="https://livewire.laravel.com" target="_blank" class="text-red-500">Livewire</a>
                            and <a href="https://alpinejs.dev" target="_blank" class="text-red-500">Alpine.js</a></p>
                    </div>
                </div>
            </blockquote>
            <blockquote class="relative w-full bg-white p-5 border border-gray-200 break-inside-avoid-column">
            ...
            <blockquote class="relative w-full bg-white p-5 border border-gray-200 break-inside-avoid-column">
                ...
                <div class="mt-5 flex items-start gap-4">
                    ...
                    <div class="text-xs">
                        ...
                        <p class="text-gray-700">Owner of <a href="https://designtotailwind.com" target="_blank" class="text-red-500">Design to Tailwind</a></p>
                    </div>
                </div>
            </blockquote>
            <blockquote class="relative w-full bg-white p-5 border border-gray-200 break-inside-avoid-column">
            ...
            <blockquote class="relative w-full bg-white p-5 border border-gray-200 break-inside-avoid-column">
                ...
                <div class="mt-5 flex items-start gap-4">
                    ...
                    <div class="text-xs">
                        ...
                        <p class="text-gray-700">Co-founder of <a href="https://usefathom.com" class="text-red-500" target="_blank">Fathom
                                Analytics</a></p>
                    </div>
                </div>
            </blockquote>
            ...
            <div class="flex justify-center lg:justify-end">
                <div class="max-w-sm w-full pt-8 pb-12 px-6 border border-gray-200 -rotate-1 lg:px-12 lg:border-red-600">
                    ...
                    <p class="mt-4 text-gray-700 text-sm leading-relaxed">Laracasts includes free videos and tutorials
                        covering the entire Laravel ecosystem. Stay up to date by watching our latest videos.</p>
                    ...
                    <ul class="mt-6 flex items-center space-x-3">
                        <li>
                            <a href="https://x.com/laravelphp">
                                <img class="hidden w-6 h-6" src="/img/social/x.dark.min.svg" alt="X" width="24" height="20" loading="lazy">
                                <img class="inline-block w-6 h-6" src="/img/social/x.min.svg" alt="X" width="24" height="20" loading="lazy">
                            </a>
                        </li>
                        <li>
                ...
                <div class="text-xs col-span-6 md:col-span-3 lg:col-span-2">
                    ...
                    <div class="mt-5">
                        <ul class="space-y-3 text-gray-700 ">
                            ...
                            <li>
                                <a href="https://larabelles.com/" class="transition-colors hover:text-gray-600 ">Larabelles</a>
                            </li>
                            <li>
                ...
                <div class="text-xs col-span-6 md:col-span-3 lg:col-span-2">
                    ...
                    <div class="mt-5">
                        <ul class="space-y-3 text-gray-700 ">
                            ...
                            <li>
                                <a href="https://www.bacancytechnology.com/hire-laravel-developer?utm_source=laravel&amp;utm_medium=partners.laravel&amp;utm_campaign=sponsors" class="transition-colors hover:text-gray-600 ">Bacancy</a>
                            </li>
                            <li>
                            ...
                            <li>
                                <a href="https://www.blackairplane.com/" class="transition-colors hover:text-gray-600 ">Black Airplane</a>
                            </li>
                            <li>
                ...
                <div class="text-xs col-span-6 md:col-span-3 lg:col-span-2">
                    ...
                    <div class="mt-5">
                        <ul class="space-y-3 text-gray-700 ">
                            ...
                            <li>
                                <a href="https://jetstream.laravel.com" class="transition-colors hover:text-gray-600 ">Jetstream</a>
                            </li>
                            <li>
                                <a href="https://livewire.laravel.com" class="transition-colors hover:text-gray-600 ">Livewire</a>
                            </li>
                            <li>
